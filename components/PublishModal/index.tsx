    ...
    <Modal open={open} onClose={onClose}>
      ...
      <div className="pt-6 pb-12">
        <Typography type="normal">
          Publishing this lecture will immediately <span className="text-warning">show it into your live site</span> and change its status
          to Published. Are you sure you want to go ahead?
        </Typography>
      </div>
