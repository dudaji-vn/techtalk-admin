...
import { IChangeStatusLectureRequest } from '../../interfaces/lecture';
    ...
    <Modal open={open} onClose={onClose}>
      ...
      <div className="pt-6 pb-12">
        <Typography type="normal">
          Unpublishing this lecture will immediately <span className="text-warning">remove it from your live site</span> and change its
          status to Draft. Are you sure you want to go ahead?
        </Typography>
      </div>
