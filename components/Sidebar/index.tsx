...
const Sidebar: React.FC<SidebarProps> = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  }, [sidebarExpanded, sidebarOpen, setSidebarOpen]);
  ...
  const navigationLinks: NavigationLink[] = [
    ...
    },
    {
      ...
      text: "Vocabularies",
      active: pathname.includes("vocabularies"),
      iconActive: <VocabularyActiveIcon />,
      icon: <VocabularyIcon />,
    },
  ];
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <img width={176} height={32} src="/images/logo/logo.svg" alt="Logo" />
        </Link>
